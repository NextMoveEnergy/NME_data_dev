...
def main():
    ...
    st.subheader("Generate Epos XML")

    uploaded_file = st.file_uploader(label="Upload XLSX file to generate XML", type=["xlsx"])
    ...
    if uploaded_file is not None:
        ...
        st.download_button("Download Epos XML", type='primary', data=convert(edited_df), file_name='book_import.xml', mime='application/xml')
