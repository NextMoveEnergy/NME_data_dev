...
pg = st.navigation([
    ...
    st.Page('_pages/ceeps_mm_mt_data_retrieval.py', title="CEEPS MT&MM data retrieval"),
    ...
    st.Page('_pages/xflex_battery_ems_dashboard.py', title="Battery EMS Monitor ŠKRLJ"),
